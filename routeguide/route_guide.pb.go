...
const file_routeguide_route_guide_proto_rawDesc = "" +
	...
	"\felapsed_time\x18\x04 \x01(\x05R\velapsedTime2\x83\x02\n" +
	"\n" +
	"RouteGuide\x126\n" +
	"\n" +
	...
	"\tRouteChat\x12\x15.routeguide.RouteNote\x1a\x15.routeguide.RouteNote(\x010\x01B8Z6google.golang.org/grpc/examples/route_guide/routeguideb\beditionsp\xe8\a"
