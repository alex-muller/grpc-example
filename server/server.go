...
func (s *routeGuideServer) GetFeature(ctx context.Context, point *pb.Point) (*pb.Feature, error) {
	fmt.Println("GetFeature called with point: ", point)
...
func inRange(point *pb.Point, rect *pb.Rectangle) bool {
	left := math.Min(float64(rect.Lo.GetLongitude()), float64(rect.Hi.GetLongitude()))
	right := math.Max(float64(rect.Lo.GetLongitude()), float64(rect.Hi.GetLongitude()))
	top := math.Max(float64(rect.Lo.GetLatitude()), float64(rect.Hi.GetLatitude()))
	bottom := math.Min(float64(rect.Lo.GetLatitude()), float64(rect.Hi.GetLatitude()))
